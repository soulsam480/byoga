...
const SECTION_TO_ICON: Record<
  TSections,
  ComponentType<JSX.SVGAttributes<SVGSVGElement>>
> = {
  ...
  return (
    <div class='p-6 w-full'>
      <div className='w-full border-base-200 border lg:w-2/3 mx-auto h-full rounded-lg'>
        <div className='text-base font-semibold p-4'>Settings</div>
        ...
        <div class='flex flex-col p-4'>
          <label className='form-control w-full'>
            <div className='label'>
              <span className='label-text inline-flex gap-2'>
                <SECTION_TO_ICON.expense className='text-expense' /> Monthly
                expense?
              </span>
            </div>
            <input
            ...
            <div className='label'>
              <span className='label-text-alt'>
                This will show up in all charts.
              </span>
            </div>
          </label>
          ...
          <label className='form-control w-full'>
            ...
            <div className='label'>
              <span className='label-text-alt'>
                Byoga will recognise investments based on category.
              </span>
            </div>
          </label>
        </div>
