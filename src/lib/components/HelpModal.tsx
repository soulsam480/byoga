    ...
    <dialog id='help_modal' className='modal'>
      <div className='modal-box overflow-hidden flex flex-col gap-2 items-start'>
        ...
        <div className='text-xs text-neutral'>
          Everything in Byoga follows a color code. Data points including
          categories, settings, etc. correspond to a unique color. This is done
          to make reading and analysing data easier.
        </div>
